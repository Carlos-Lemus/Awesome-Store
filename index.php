        ...
        <nav class="navbar text-center navbar-expand-lg navbar-light bg-light">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-item nav-link" href="productos.php"
                  ><i class="fas fa-mobile"></i> Productos</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a title="Sign in" class="text-primary nav-item nav-link" href="#">                  
        ...
        <div class="row">
          <div class="col-md-5 text-center align-self-center">
            <div>
              ...
              <button class="btn btn-primary btn-lg">Explorar</button>
            </div>
          </div>

        ...
        <div class="col-md-6">
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  src="https://falabella.scene7.com/is/image/FalabellaCO/3820957_1?q=i?wid=800&hei=800&qlt=70"
                  class="card-img"
                  alt="..."
                />
              </div>
        ...
        <div class="col-md-6">
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters card-deck">
              <div class="col-md-4">
                <img
                  src="https://samsungmx.vteximg.com.br/arquivos/ids/160779-600-600/SM-N975FZKDACR-2000_1.jpg?v=637030332057570000"
                  class="card-img"
                  alt="..."
                />
              </div>
        ...
        <div class="col-md-6">
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  src="https://images.samsung.com/is/image/samsung/nz-galaxy-tab-a-2019-101-sm-t510nzsdxnz-frontsilver-thumb-162007695"
                  class="card-img"
                  alt="..."
                />
              </div>
        ...
        <div class="col-md-6">
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  src="https://www.cqnetcr.com/74964-large_default/laptop-lenovo-ideapad-s340-156-ryzen-5-8gb-2tb.jpg"
                  class="card-img"
                  alt="..."
                />
              </div>
        ...
        <div class="col-md-6">
          <div class="card mb-3" style="max-width: 540px;">
            <div class="row no-gutters">
              <div class="col-md-4">
                <img
                  src="https://media.nidux.net/pull/599/800/3310/123114-product-5e1657ea2bd97-nbhp6qw11la-1.jpg"
                  class="card-img"
                  alt="..."
                />
              </div>
